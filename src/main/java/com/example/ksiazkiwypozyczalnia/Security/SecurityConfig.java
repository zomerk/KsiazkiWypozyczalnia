...
//                 //Default Basic auth config
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("user/api/books").hasAnyRole("USER", "ADMIN")
                        .requestMatchers("user/api/articles").hasAnyRole("USER", "ADMIN")
                        .requestMatchers("/user/api/createUser").hasAnyRole("ADMIN")
                        .requestMatchers("/articlerent/api/acceptList").hasAnyRole("ADMIN")
                        .requestMatchers("/bookrent/api/create").hasAnyRole("ADMIN","USER")
                        .requestMatchers("/bookrent/api/**").hasAnyRole("ADMIN")
